  ...
  if (onClick) {
    return (
      <button
        onClick={onClick}
        aria-pressed={active}
        className={`${classes} cursor-pointer transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#60a5fa] focus-visible:ring-offset-1 focus-visible:ring-offset-black ${
          active
