...
export const myExperiences: Experience[] = [
  {
    ...
    technologies: ["Python", "Pandas", "NumPy", "statsmodels", "Simulation"],
  ...
  },
  {
    ...
    description:
      "Delivered strategic industry research and designed scalable solutions utilizing Azure cloud and AI frameworks for enterprise clients.",
    points: [
    ...
    technologies: ["Azure", "Data Analysis"],
    location: "Remote",
    featured: true,
    logo: uwaterlooLogo,
    logoAlt: "University of Waterloo logo",
